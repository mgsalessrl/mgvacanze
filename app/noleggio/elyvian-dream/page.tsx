...
export const metadata: Metadata = getSeoMetadata('elyvian-dream');
...
export default async function Page() {
  ...
  return <BoatDetailLayout data={{ ...boatData['elyvian-dream'], extraOptions: extras || [], discounts: discounts || [] }} />;
}
